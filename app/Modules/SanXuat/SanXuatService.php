...
class SanXuatService
{
  ...
  public function create(array $data)
  {
    try {
      ...
      $data['gia_thanh_san_xuat'] = ceil(($giaCost + $data['chi_phi_khac']) / $data['so_luong'] / 1000) * 1000;
      $data['gia_ban_de_xuat'] = ceil($data['gia_thanh_san_xuat'] * (1 + $data['loi_nhuan'] / 100) / 1000) * 1000;
